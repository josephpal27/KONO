...
document.querySelectorAll('.web-rounded-card').forEach((card, index) => {
  ...
  document.querySelectorAll('.web-slider-container .card').forEach((card, index) => {
    let img = card.querySelector('img');
    let originalSrc = `assets/images/product-slider/brick/product-slide-${index + 1}.jpg`;
    let hoverSrc = `assets/images/product-slider/brick/product-slide-${index + 1}-light.jpg`;
