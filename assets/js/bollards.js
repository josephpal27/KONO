...
document.querySelectorAll('.web-rounded-card').forEach((card, index) => {
    ...
    let originalSrc = `assets/images/rounded-cards/bollards/rounded-card-${index + 1}.webp`;
    let hoverSrc = `assets/images/rounded-cards/bollards/rounded-card-${index + 1}-light.webp`;
  ...
  document.querySelectorAll('.web-slider-container .card').forEach((card, index) => {
    let img = card.querySelector('img');
    let originalSrc = `assets/images/product-slider/bollards/product-slide-${index + 1}.webp`;
    let hoverSrc = `assets/images/product-slider/bollards/product-slide-${index + 1}-light.webp`;
